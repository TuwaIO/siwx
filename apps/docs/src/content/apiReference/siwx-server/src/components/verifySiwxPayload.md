...
Defined in: [packages/siwx-server/src/server.ts:37](https://github.com/TuwaIO/siwx/blob/83013b6156828e4328756382b00fca539cc26a69/packages/siwx-server/src/server.ts#L37)
